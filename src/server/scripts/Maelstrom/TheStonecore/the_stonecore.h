...
const Position azilShieldPhase[2] =
{
    { 1332.81f, 982.10f, 207.56f, 1.78f },
    { 1337.30f, 964.89f, 214.18f, 1.74f },
};
...
enum CreatureIds
{
    ...
    NPC_RUPTURE_SPIKE              = 51423,
    NPC_CAMERA_BUNNY               = 42565,
    NPC_SIESMIC_SHARD              = 42355,
};
...
enum GameObjectIds
{
    ...
    GO_STALAKTITE                  = 204337,
};

enum eActions
{
    ACTION_MANASTORM_PULL,
    ACTION_STALACTITE_REMOVE,
    ACTION_CORBORUS_ANIM,
    ACTION_CORBORUS_CONE,
    ACTION_AZIL_SHIELD,
    ACTION_LAUNCH_SHARD,
};
