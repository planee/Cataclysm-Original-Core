...
static const Position AtramedesPos = {385.094f, -315.484f, 136.624f, 3.14f };
    ...
    public:
        ...
        struct instance_blackwing_descent_InstanceMapScript : public InstanceScript
        {
            instance_blackwing_descent_InstanceMapScript(InstanceMap* map) : InstanceScript(map)
            {
                ...
                trgCount                = 0;
                onyxiaGUID              = 0;
                nefariousInstanceIntroState = NOT_STARTED;
                nefariousOmnomtronIntroState = NOT_STARTED;
                nefariousMaloriakIntroState = NOT_STARTED;
                nefariousAtramedesIntroState = NOT_STARTED;
            ...
            void SetData(uint32 type, uint32 data) override
            {
                switch (type)
                {
                    case DATA_NEFARIOUS_INSTANCE_INTRO_STATE:
                        {
                            nefariousInstanceIntroState = data;
                            SaveToDB();
                            break;
                        }
                    case DATA_NEFARIOUS_OMNONTRON_INTRO_STATE:
                        {
                            nefariousOmnomtronIntroState = data;
                            SaveToDB();
                            break;
                        }
                    case DATA_NEFARIOUS_MALORIAK_INTRO_STATE:
                        {
                            nefariousMaloriakIntroState = data;
                            SaveToDB();
                            break;
                        }
                    case DATA_NEFARIOUS_ATRAMEDES_INTRO_STATE:
                        {
                            nefariousAtramedesIntroState = data;
                            SaveToDB();
                            break;
                        }
                    case DATA_DRAKONID:
            ...
            uint32 GetData(uint32 type) const override
            {
                ...
                {
                    case DATA_NEFARIOUS_INSTANCE_INTRO_STATE:
                        return nefariousInstanceIntroState;
                    case DATA_NEFARIOUS_OMNONTRON_INTRO_STATE:
                        return nefariousOmnomtronIntroState;
                    case DATA_NEFARIOUS_MALORIAK_INTRO_STATE:
                        return nefariousMaloriakIntroState;
                    case DATA_NEFARIOUS_ATRAMEDES_INTRO_STATE:
                        return nefariousAtramedesIntroState;
                    default:
                        return 0;
                }
            }
            ...
            {
                data << drakonidCnt << ' ' << nefariousInstanceIntroState
                    << ' ' << nefariousOmnomtronIntroState << ' ' << nefariousMaloriakIntroState
                << ' ' << nefariousAtramedesIntroState;
            }

            void ReadSaveDataMore(std::istringstream& data) override
            {
                data >> drakonidCnt >> nefariousInstanceIntroState 
                >> nefariousOmnomtronIntroState >> nefariousMaloriakIntroState >> nefariousAtramedesIntroState;
            }
        ...
        private:
            ...
            uint32 nefariousInstanceIntroState;
            uint32 nefariousOmnomtronIntroState;
            uint32 nefariousMaloriakIntroState;
            uint32 nefariousAtramedesIntroState;
        };
