...
{
    { -1053.54f, -564.38f, 835.02f, 5.81f }, // aqurarion
    { -1054.04f, -600.60f, 835.03f, 0.42f }, // ognis
    { -1057.89f, -653.51f, 877.70f, 0.79f }, // arion
    { -1057.93f, -533.38f, 877.68f, 5.47f }, // terrastra
};

const Position groundPos[7] = 
{
    { -1038.45f, -590.60f, 831.98f, 6.04f }, // arion 2td jump
    { -1034.61f, -571.70f, 831.90f, 6.04f }, // terrastra 2td jump
    { -1008.42f, -571.32f, 831.90f, 4.71f }, // 3td primal point of aquarion
    { -995.92f, -582.68f, 831.90f, 3.18f  }, // 3td primal point of ognis
    { -1008.75f, -594.82f, 831.90f, 1.52f }, // 3td primal point of arion
    { -1020.88f, -582.67f, 831.90f, 0.0f  }, // 3td primal point of terrastra
    { -1008.58f, -582.97f, 831.90f, 6.23f }, // 3td primal point of mostrosity
};
                    ...
                    switch (eventId)
                    {
                        ...
                        case EVENT_HYDROLANCE:
                        {
                            ...
                            if (me->getThreatManager().getThreatList().size() > 1)
                                position = 1;
                            if (Unit* target = SelectTarget(SELECT_TARGET_RANDOM, position, 100.0f, true))
                    ...
                    switch (eventId)
                    {
                        ...
                        case EVENT_INFERNO_JUMP:
                            ...
                            if (!target)
                            {
                                ...
                                if (me->getThreatManager().getThreatList().size() > 1)
                                    position = 1;
                                target = SelectTarget(SELECT_TARGET_RANDOM, position, 100.0f, true);
                            }
                            if (target)
                            {
                                me->SetReactState(REACT_PASSIVE);
    ...
    public:
        ...
        struct boss_elementium_monstrosityAI : public BossAI
        {
            ...
            void EnterEvadeMode() override
            {
                ...
                if (Creature* _arion = ObjectAccessor::GetCreature(*me, instance->GetData64(DATA_ARION)))
                {
                    _arion->SetReactState(REACT_PASSIVE);
                    _arion->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NON_ATTACKABLE);
                    _arion->SetVisible(true);
                    _arion->AI()->EnterEvadeMode();
                }
                if (Creature* _terrastra = ObjectAccessor::GetCreature(*me, instance->GetData64(DATA_TERRASTRA)))
                {
                    _terrastra->SetReactState(REACT_PASSIVE);
                    _terrastra->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NON_ATTACKABLE);
                    _terrastra->SetVisible(true);
                    _terrastra->AI()->EnterEvadeMode();
                }
                if (Creature* _ignacious = ObjectAccessor::GetCreature(*me, instance->GetData64(DATA_IGNACIOUS)))
    ...
    public:
        ...
        struct npc_bt_gravity_wellAI : public ScriptedAI
        {
            ...
            void SpellHitTarget(Unit* target, SpellInfo const* spellInfo) override
            {
                if (target)
                {
                    if (spellInfo->Id == SPELL_GROUNDED)
    ...
    public:
        ...
        class spell_arion_lashing_winds_SpellScript : public SpellScript
        {
            ...
            void HandleScript(SpellEffIndex /*effIndex*/)
            {
                ...
                GetHitUnit()->RemoveAura(SPELL_GROUNDED);
...
class spell_arion_disperse : public SpellScriptLoader
{
    public:
        ...
        class spell_arion_disperse_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                AfterCast += SpellCastFn(spell_arion_disperse_SpellScript::HandleAfterCast);
            }
        };
    ...
    public:
        ...
        class spell_terrastra_eruption_SpellScript : public SpellScript
        {
            ...
            void HandleScript(SpellEffIndex /*effIndex*/)
            {
                ...
                uint32 position = 0;
                if (Creature* terrastra = GetCaster()->ToCreature())
                    if (terrastra->getThreatManager().getThreatList().size() > 1)
                        position = 1;
                if (Unit* target = GetCaster()->GetAI()->SelectTarget(SELECT_TARGET_RANDOM, position, 100.0f, true))
...
class spell_terrastra_quake : public SpellScriptLoader
{
    public:
        ...
        class spell_terrastra_quake_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnHit += SpellHitFn(spell_terrastra_quake_SpellScript::HandleScript);
            }
        };
