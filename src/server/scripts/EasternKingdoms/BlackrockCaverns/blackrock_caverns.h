...
const Position twilightDefenderPos[4] =
{
    { 341.80f, 577.63f, 66.00f, 3.11f },
    { 351.48f, 568.34f, 66.00f, 3.11f },
    { 351.12f, 554.34f, 66.00f, 3.11f },
    { 342.56f, 545.16f, 66.00f, 3.11f },
};

const Position lastStandByKaz[2] =
{
    { 304.85f, 618.99f, 65.70f, 4.68f },
    { 339.10f, 559.88f, 66.00f, 0.16f },
};
...
enum eActions
{
    ACTION_RAZ_BREAK_PRISON,
    ACTION_RAZ_NEXT_BRIDGE,
    ACTION_SUPERHEATED_ARMOR_REMOVE,
    ACTION_QUICKSILVER,
    ACTION_RAZ_LAST_STAND,
};
